                        ...
                        actions={[
                            {
                              ...
                              onClick: (event, rowData) => {
                                ...
                                // console.log(rowData);
                                // history.pushState( 'showCategory', '/category')
                                // this.props.history.push('/category', 'showCategory')
                                this.props.history.push("/category", { show: 'showCategory' })
                                // this.props.history.push({
                                //   pathname: '/category',
                                //   state: 'showCategory'
                                // })

                                this.props.onSendCategoryTitle(rowData.title, rowData.guid)
                                // this.props.history.push('showPostEdit', '/postEdit')
