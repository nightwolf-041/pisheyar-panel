...
const styles = theme => ({
 ...
 class PostEdit extends React.Component {
      ...
      axiosConfig.get(`/Post/GetByGuid/${guid}`, {
        ...
        let defaultImage = [
          ...
          this.setState({
            ...
            // postDefaultTags: res.data.post.postTitle,
            categoriesDefaultNames: res.data.post.categories,
            errorOnLoadData: false
          })
  ...
  let {post} = this.state
  console.log(this.state.categoriesNames[0]);
        ...
        : null}
          ...
          : null }
            ...
            <Autocomplete
              ...
              // defaultValue={this.state.postDefaultTags}
              freeSolo
          ...
          {!this.state.loadingCategoriesNames ?
            <Autocomplete
            ...
            />
            :
            <TextField label='در حال بارگیری...' varient="outlined" disabled fullWidth InputProps={{...params.InputProps}} />}
