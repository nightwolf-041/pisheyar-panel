 ...
 class PostEdit extends React.Component {
   constructor(props) {
     ...
     this.state = {
      ...
      files: [{
          // source: "http://185.94.97.164/Uploads/20200414141020photo_2019-11-26_21-37-47.jpg",
          // options: {
          //   type: 'local',
          //   file: {
          //       name: 'my-file.png',
     ...
     return (
       ...
       <PanelMain header={<PanelMainPostEditehead />}>
        ...
        <FilePond ref={ref => this.pond = ref}
          ...
          imageValidateSizeLabelFormatError="نوع عکس معتبر نیست"
          imageValidateSizeLabelImageSizeTooSmall="عکس خیلی کوچک است"
