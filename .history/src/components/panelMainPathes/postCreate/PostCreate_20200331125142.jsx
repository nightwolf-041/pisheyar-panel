            ...
            <div style={{position: 'relative'}}>
              ...
              init = {{
                ...
                plugins: ['advlist autolink lists link image charmap print preview anchor',
                  ...
                  'insertdatetime media table paste code blockquote help wordcount directionality hr fullscreen casechange hr formatpainter ',
                  'save '],
                mobile: {
                ...
                'insertdatetime | table | ltr rtl | fullscreen fullpage | save | casechange \
                hr | formatpainter | emoticons '],
