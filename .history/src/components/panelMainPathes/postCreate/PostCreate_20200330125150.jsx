...
const editorConfiguration = {
  plugins: [Essentials, Bold, Italic, Underline, Paragraph, Heading, Alignment, FontColor, FontSize, list, Image, EasyImage, Table, TableCell, TableToolbar ],

  toolbar: ["bold", "italic", "underline", "heading", "alignment", "fontcolor", "fontsize",
  'list', 'bulletedList', 'numberedList', "image", "imageupload", "table", "tablecell", "tabletoolbar" ],
