      ...
      <PanelMain header={<PanelMainPostCreatehead />}>
        <CKEditor style={{height: '400px'}}
          ...
          config={
            ...
            {
              plugins: [Undo, Essentials, Bold, Italic, Underline, HorizontalLine, Paragraph,       Blockquote,
              Codeblock, Heading, Alignment, Highlight, Font, FontSize, list, Table, Image, ImageToolbar, ImageCaption, ImageStyle, ImageResize, Base64UploadAdapter, EasyImage ],
              
                toolbar: ["undo", "bold", "italic", "underline", "horizontalline", "blockquote", "codeblock", "heading", "alignment", "highlight","fontcolor", "fontBackgroundColor", "fontsize", "image",
                'list', 'bulletedList', 'numberedList', "table", "imageupload" ],

                image: {
                  toolbar: [ 'imageTextAlternative', '|', 'imageStyle:full', 'imageStyle:side', 'imageStyle:alignLeft' ],
                  styles: [
                    'full',
                    'alignLeft',
                    'alignRight'
