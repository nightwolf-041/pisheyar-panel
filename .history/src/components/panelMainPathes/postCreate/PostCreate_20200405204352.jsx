        ...
        <CKEditor style={{height: '400px'}}
          ...
          config={
            
            {
              ...
              Codeblock, Heading, Alignment, Indent, IndentBlock, PasteFromOffice, Highlight, Font, FontSize, list, Table, TableToolbar, TableProperties, TableCellProperties, Image, ImageToolbar, ImageCaption, ImageStyle, ImageResize, ImageUpload, Link, Base64UploadAdapter, MediaEmbed, Clipboard ],
