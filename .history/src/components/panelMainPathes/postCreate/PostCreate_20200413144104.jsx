...
class PostCreate extends Component {
  ...
  sendDataHandler = () => {
    ...
    if(titleValue.length === 0 || abstractValue.length === 0 ||   descriptionValue.length === 0 || postTags.length === 0 || categoryName.length === 0) {
    ...
    return (
      <PanelMain header={<PanelMainPostCreatehead />}>
        ...
        <FilePond ref={ref => this.pond = ref}
          ...
          onprocessfile={(error, file) => console.log(file)}
