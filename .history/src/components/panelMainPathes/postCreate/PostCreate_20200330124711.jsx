...
const editorConfiguration = {
  plugins: [Essentials, Bold, Italic, Underline, Paragraph, Heading, Alignment, FontColor, FontSize, Image, EasyImage, list],

  toolbar: ["bold", "italic", "underline", "heading", "alignment", "fontcolor", "fontsize", "image", "imageupload", 'bulletedList', 'numberedList', 'list'],
