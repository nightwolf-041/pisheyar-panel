...
class PostCreate extends Component {
  ...
  :
  ["undo", "redo",'|', "bold", "italic", "underline", "horizontalline", "blockquote", '|', "insertTable", "specialCharacters", '|', "heading", "alignment", '|', 'outdent', 'indent', '|', "highlight","fontcolor", "fontBackgroundColor", "fontsize", '|', "image",'bulletedList', 'numberedList', '|', "table", "imageupload", "mediaEmbed", "link"]
    ...
    return (
      ...
      <div style={{width: '95%', height: 'auto', margin: '0 auto'}}>
        ...
        <BootstrapTooltip placement="left" title="صفحه عادی">
