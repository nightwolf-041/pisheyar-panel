...
const editorConfiguration = {
  plugins: [Undo, Essentials, Bold, Italic, Underline, HorizontalLine, Paragraph, Heading, Alignment, Highlight, FontColor, FontSize, list, Image, EasyImage ],

  toolbar: ["undo", "bold", "italic", "underline", "horizontalline", "heading", "alignment", "highlight","fontcolor", "fontsize",
