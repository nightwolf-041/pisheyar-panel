            ...
            <div style={{position: 'relative'}}>
              ...
              init = {{
                ...
                plugins: ['advlist autolink lists link image charmap print preview anchor',
                  ...
                  'insertdatetime media table paste code blockquote help wordcount directionality hr casechange hr formatpainter fullpage',
                  'save '],
                mobile: {
                ...
                insertdatetime | table | ltr rtl | fullpage | save | casechange \
                hr | formatpainter '],
