...
const editorConfiguration = {
  plugins: [Undo, Essentials, Bold, Italic, Underline, HorizontalLine, Paragraph, Blockquote, Heading, Alignment, Highlight, FontColor, FontSize, list, Image, EasyImage ],

  toolbar: ["undo", "bold", "italic", "underline", "horizontalline", "blockquote", "heading", "alignment", "highlight","fontcolor", "fontsize",
  'list', 'bulletedList', 'numberedList', "image", "imageupload" ],
