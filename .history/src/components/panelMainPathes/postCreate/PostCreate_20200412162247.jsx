...
class PostCreate extends Component {
  ...
  sendDataHandler = () => {
    ...
    if(titleValue.length === 0 || abstractValue.length === 0 || descriptionValue.length === 0 || postTags.length === 0) {
