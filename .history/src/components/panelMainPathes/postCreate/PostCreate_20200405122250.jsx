        ...
        <CKEditor style={{height: '400px'}}
          ...
          config={
            
            {
              ...
              Codeblock, Heading, Alignment, Indent, IndentBlock, Highlight, Font, FontSize, list, Table, Link, Image, ImageToolbar, ImageCaption, ImageStyle, ImageResize, Base64UploadAdapter, EasyImage ],
