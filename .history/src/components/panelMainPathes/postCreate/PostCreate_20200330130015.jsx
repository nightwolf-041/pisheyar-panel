...
const editorConfiguration = {
  plugins: [Undo, Essentials, Bold, Italic, HorizontalLine, Underline, Paragraph, Heading, Alignment, FontColor, FontSize, list, Image, EasyImage ],

  toolbar: ["undo", "bold", "italic", "horizontalline", "underline", "heading", "alignment", "fontcolor", "fontsize",
