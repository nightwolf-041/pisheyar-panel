...
const editorConfiguration = {
  plugins: [Essentials, Bold, Italic, Underline, Paragraph, Heading, Alignment, FontColor, FontSize, Image],
  toolbar: ["bold", "italic", "underline", "heading", "alignment", "fontcolor", "fontsize", "image"]
};
