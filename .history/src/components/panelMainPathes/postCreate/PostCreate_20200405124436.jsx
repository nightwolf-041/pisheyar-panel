          ...
          config={
            
            {
              ...
              Codeblock, Heading, Alignment, Indent, IndentBlock, PasteFromOffice, Highlight, Font, FontSize, list, Table, Image, ImageToolbar, ImageCaption, ImageStyle, ImageResize, Link, Base64UploadAdapter, EasyImage, MediaEmbed ],
                ...
                toolbar: ["undo", "redo", "removeFormat", '|', "bold", "italic", "underline", "horizontalline", "blockquote", "codeblock", '|', "heading", "alignment", '|', 'outdent', 'indent', '|', "fontFamily", "highlight","fontcolor", "fontBackgroundColor", "fontsize", '|', "image",'bulletedList', 'numberedList', '|', "table", "link", "imageupload", "mediaEmbed" ],
