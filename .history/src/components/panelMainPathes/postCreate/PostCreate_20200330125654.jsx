...
import Rado from '@ckeditor/ckeditor5-undo/src/redocommand'

const editorConfiguration = {
  plugins: [Undo, Rado, Essentials, Bold, Italic, Underline, Paragraph, Heading, Alignment, FontColor, FontSize, list, Image, EasyImage ],

  toolbar: ["undo", "rado", "bold", "italic", "underline", "heading", "alignment", "fontcolor", "fontsize",
