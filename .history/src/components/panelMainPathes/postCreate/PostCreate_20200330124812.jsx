...
const editorConfiguration = {
  plugins: [Essentials, Bold, Italic, Underline, Paragraph, Heading, Alignment, FontColor, FontSize, Image, list, EasyImage ],

  toolbar: ["bold", "italic", "underline", "heading", "alignment",'list', "fontcolor", "fontsize", "image", "imageupload", 'bulletedList', 'numberedList'],
