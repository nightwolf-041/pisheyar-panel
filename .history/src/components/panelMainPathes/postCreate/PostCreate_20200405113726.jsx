      ...
      <PanelMain header={<PanelMainPostCreatehead />}>
        <CKEditor style={{height: '400px'}}
          ...
          config={
            ...
            {
              plugins: [Undo, Essentials, Bold, Italic, Underline, HorizontalLine, Paragraph,       Blockquote,
              Codeblock, Heading, Alignment,Indent, Highlight, Font, FontSize, list, Table, Image, ImageToolbar, ImageCaption, ImageStyle, ImageResize, Base64UploadAdapter, EasyImage ],
