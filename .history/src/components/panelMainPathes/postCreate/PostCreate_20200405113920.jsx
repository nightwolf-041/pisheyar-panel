          ...
          config={
            
            {
              ...
              Codeblock, Heading, Alignment, Indent, IndentBlock, Highlight, Font, FontSize, list, Table, Image, ImageToolbar, ImageCaption, ImageStyle, ImageResize, Base64UploadAdapter, EasyImage ],
                ...
                toolbar: ["undo", "redo", '|', "bold", "italic", "underline", "horizontalline", "blockquote", "codeblock", "heading", "alignment", '|', 'outdent', 'indent', '|', "highlight","fontcolor", "fontBackgroundColor", "fontsize", "image",
