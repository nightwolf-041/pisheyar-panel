...
class PostCreate extends Component {
  ...
  if(window.innerWidth < 500){
    this.bigToolbar=["bold", "horizontalline", "blockquote", '|','|', "heading", "alignment", '|', '|', "fontcolor", "fontBackgroundColor", "fontsize", '|', "image",'bulletedList', 'numberedList', '|', "imageupload", "link"]
  }
