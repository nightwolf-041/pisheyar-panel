      ...
      <div style={{width: '80% !important', height: 'auto', margin: '0 auto', overflow: 'hidden !important'}}>
        ...
        <CKEditor
          ...
          config={
            ...
            {
              plugins: [Undo, RemoveFormat, Essentials, Bold, Italic, Underline, BlockToolbar, HorizontalLine, Paragraph, Blockquote,  SpecialCharacters, SpecialCharactersCurrency, SpecialCharactersMathematical,
