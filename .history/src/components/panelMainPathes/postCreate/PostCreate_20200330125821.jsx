...
const editorConfiguration = {
  plugins: [Undo, Essentials, Bold, Italic, Underline, Paragraph, Heading, Alignment, FontColor, FontSize, SpecialCharacters, list, Image, EasyImage ],

  toolbar: ["undo", "bold", "italic", "underline", "heading", "alignment", "fontcolor", "fontsize",
  'specialcharacters', 'list', 'bulletedList', 'numberedList', "image", "imageupload" ],
