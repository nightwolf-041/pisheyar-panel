...
const editorConfiguration = {
  plugins: [Essentials, Bold, Italic, Underline, Paragraph, Heading, Alignment, FontColor, FontSize, list, Image, EasyImage ],

  toolbar: ["bold", "italic", "underline", "heading", "alignment",'list', "fontcolor", "fontsize", 'bulletedList', 'numberedList', "image", "imageupload"],
