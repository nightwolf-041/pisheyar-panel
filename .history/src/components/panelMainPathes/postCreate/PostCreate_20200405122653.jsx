          ...
          config={
            
            {
              ...
              Codeblock, Heading, Alignment, Indent, IndentBlock, Highlight, Font, FontSize, list, Table, Image, ImageToolbar, ImageCaption, ImageStyle, ImageResize, Link, Base64UploadAdapter, EasyImage, MediaEmbed ],
                ...
                toolbar: ["undo", "redo", '|', "bold", "italic", "underline", "horizontalline", "blockquote", "codeblock", '|', "heading", "alignment", '|', 'outdent', 'indent', '|', "fontFamily", "highlight","fontcolor", "fontBackgroundColor", "fontsize", '|', "image", "link", '|','bulletedList', 'numberedList', '|', "table", "imageupload" ],
