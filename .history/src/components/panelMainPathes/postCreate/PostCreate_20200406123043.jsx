...
class PostCreate extends Component {
  ...
  this.bigToolbar = window.innerWidth >= 992 ?
  ...
  :
  ["undo", "redo",'|', "bold", "horizontalline", "blockquote", '|', "insertTable",'|', "heading", "alignment", '|', 'outdent', 'indent', '|', "fontcolor", "fontBackgroundColor", "fontsize", '|', "image",'bulletedList', 'numberedList', '|', "table", "imageupload", "link"]

    return (
      <PanelMain header={<PanelMainPostCreatehead />}>

      <div style={{width: '80% !important', height: 'auto', margin: '0 auto', overflow: 'hidden !important'}}>
        ...
        <CKEditor
          ...
          config={
            ...
            {
              plugins: [Undo, RemoveFormat, Essentials, Bold, Italic, Underline, BlockToolbar, HeadingButtonsUI, HorizontalLine, Paragraph, Blockquote,  SpecialCharacters, SpecialCharactersCurrency, SpecialCharactersMathematical,
