      ...
      <PanelMain header={<PanelMainPostCreatehead />}>
        <CKEditor style={{height: '400px'}}
          ...
          config={
            {
              plugins: [Undo, Essentials, Bold, Italic, Underline, HorizontalLine, Paragraph, Blockquote,
                Codeblock, Heading, Alignment, Highlight, Font, FontSize, list, Table, Image, EasyImage, CKfinder ],
                ...
                'list', 'bulletedList', 'numberedList', "table", "imageupload", "easyimage",  "ckfinder" ],
