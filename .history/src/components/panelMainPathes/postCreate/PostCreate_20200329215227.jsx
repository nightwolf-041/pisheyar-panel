...
import DecoupledEditor from '@ckeditor/ckeditor5-build-decoupled-document/build';
...
const PostCreate = () => {
  ...
  // let [model, setModel] = React.useState('Example text')

  // let handleModelChange = (givModel) => {
  //   setModel(givModel)
  // }
