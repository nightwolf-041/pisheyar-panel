...
const editorConfiguration = {
  ...
  Codeblock, Heading, Alignment, AlignmentUi, Highlight, FontColor, FontSize, list, Image, EasyImage, Table ],

  toolbar: ["undo", "bold", "italic", "underline", "horizontalline", "blockquote", "codeblock", "heading", "alignment", "alignmentui", "highlight","fontcolor", "fontsize",
